...
# System config
 use constant ADMIN_PASS => 'pi';			# Admin password. For fucks's sake, change this.
 use constant SECRET => 'piwhore23.';				# Cryptographic secret. CHANGE THIS to something totally random, and long.
...
# Page look
use constant TITLE => 'Anyfesto  board';	# Name of this image board
